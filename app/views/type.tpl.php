<section class="hero">
    <div class="container">
        ...
        <ol class="breadcrumb justify-content-center">
            ...
            <li class="breadcrumb-item active"><?= $type->getName(); ?></li>
        </ol>
        <!-- Hero Content-->
        <div class="hero-content pb-5 text-center">
            <h1 class="hero-heading"><?= $type->getName(); ?></h1>
        </div>
    </div>
</section>
            ...
            <?php foreach ($products as $product) :
                ...
                <div class="product col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="product-action-buttons">
                        ...
                        <a href="<?= $link; ?>" class="btn btn-dark btn-buy"><i class="fa-search fa"></i><span class="btn-buy-label ml-2">Voir</span></a>
                    </div>
                    <div class="py-2">
                        <p class="text-muted text-sm mb-1">
                            <?= $product->getTypeName(); ?>
                        </p>
                        <h3 class="h6 text-uppercase mb-1"><a href="<?= $link ?>" class="text-dark"><?= $product->getName(); ?></a></h3><span class="text-muted"><?= $product->getPrice(); ?>€</span>
                    </div>
                </div>
                <!-- /product-->
            <?php endforeach; ?>
